...
const CwvDashboard = ({ cwvreport, threshold = defaultConfig }) => {
    return (_jsx("div", { children: _jsx("div", { className: "min-h-screen bg-gray-50", children: _jsx(PerformanceMetricsDashboard, { data: cwvreport, config: threshold }) }) }));
};
